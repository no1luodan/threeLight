...
// create by zcy 2016/10/10
	...
	function runCircle(settings){
		...
		R1=parseInt(canvasW/2-lineW1-lineW0-adjnum);	//环的半径
		var ra=parseInt(canvasW/2-lineW0/2-5);
		var canvasH=canvasW;		//宽=高
		...
		var x=canvasC.width/2;			//圆心坐标
		var y=canvasC.height/2.2;		//圆心坐标
		...
		function CanvasApp(){
			...
			function drawScreen(){
				...
				//context.drawImage(imageAir,imgX,imgY,imgWidth,imgHeight)		//不显示小火箭
				context.restore();
